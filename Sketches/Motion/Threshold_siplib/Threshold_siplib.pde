...
void setup()
{
  ...
  // Video
  movie = new Movie(this, "A111_06.Gruppo5EntrataSeparata_ds.mov");
  //movie.loop();
  
  siplib = new SIPLib(this, 256, 256);
  //siplib.closingPass = 2;

  
  img = loadImage("cameraman.png");
  
  imgCurrentFrame = img;
  
  siplib.opencv.loadImage(img);
  siplib.opencv.adaptiveThreshold(101,2);
  
  siplib.imgSegment = siplib.opencv.getSnapshot();
  siplib.imgSegment.save("cameraman_at.png");
